...
fun TravelMapView(
    ...
    Box(
        // Flat Canvas stays inside the playback area, including during fullscreen changes.
        modifier = modifier.clipToBounds().testTag("playback-surface")
        ...
        com.traveler.feature.map.flat.FlatMapLayer(renderer, renderModel, currentActiveState, isPlaying,
            showMapOptions, onDismissMapOptions,
            if (playbackSession && controlsVisible) controlsHeight + 4.dp else 8.dp)
