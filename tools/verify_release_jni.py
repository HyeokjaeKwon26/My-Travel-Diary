...
if __name__ == "__main__":
    ...
    with zipfile.ZipFile(apks[0]) as apk:
        ...
        with apk.open("assets/basemap_3d.bin") as basemap:
            assert basemap.read(8) == b"MAP3\x00\x00\x00\x01", "Bundled flat cartography missing or invalid"
    print("Release contracts passed: native fields, ESRI resources, bundled flat cartography")
